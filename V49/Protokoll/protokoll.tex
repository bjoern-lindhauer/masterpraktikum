...
\subsection{Carr-Purcell- und die Meiboom-Gill-Methode}
Spin-Echo-Methode nach 3b ist in der Praxis zeitraubend,ursprüngliche Gleichgewichts-magnetisierung M0 in 
z-Richtung wieder
Carr und Purcell vorgeschlagenen Methode
Nach $90^\circ$ mehrere $180^\circ$ äquidistant im Abstand 2$\tau$ aufeinanderfolgen
\begin{figure}[H]
\centering
...
\end{figure}
$2n\tau$ $n\in \mathbb{N}$ Spins fokussieren - Echoamplitude nimmt mit Zeit ab durch Relaxionsprozesse
--> Messung nach \ref{eq::rechnung_tau_spin_echo}
--> Jedoch nur exakt, wenn $180^\circ$ exakt, sonst aus Messebene rausdreht mit jedem Puls
--> Lösung Meiboom-Gill-Methode:
180$^\circ$-Puls speziellen Vorrichtung um 90$^\circ$ in der Phase gegenüber den Schwingungen im 90$^\circ$-Puls verschoben, sodass bereits beim 1. 180$^\circ$-Puls $\vec{B}$ nicht mehr in $\vec{\tilde{e}}_x$-Richtung sondern in $\vec{\tilde{e}}_y$-Richtung weist. Während eines 180$^\circ$-Pulses werden die Spins nun um die $\vec{\tilde{e}}_y$-Richtung geklappt.

Dadurch ist  jeder Zweite Impuls Spins zurück in der Ebene ist
Abbildung
\begin{figure}[H]
\centering
...
Unter der Annahme,dass die T$_D$ groß gegen T$_2$ ist, d.h. $\tau
