...
Gemäß der Stabilitätsbedingung aus Gleichung \ref{eq:stabilitaet} wurden dann Graphen erstellt, an welchen die maximale Distanz L abzulesen ist. Diese sind in Abbildung \ref{fig:stab1} und in Abbildung \ref{fig:stab2} zu sehen. \\
\begin{center}
...
\subsection{Vermessung der Polarisation}
