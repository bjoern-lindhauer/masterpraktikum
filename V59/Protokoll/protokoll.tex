...
\begin{center}
	...
	\captionof{figure}{Frequenzspektrum des amplitudenmodulierten Signals über einen grö\ss eren Frequenzbereich. Die Oberwellen des Signals können gut erkannt werden.}
...
Mithilfe von Gleichung (5) und dem Frequenzhub, der aus Abbbildung \ref{fig:freqmodfreq} entnommen werden kann, ergibt sich der Modulationsgrad zu 0.215$\pm0.008$. \\
...
\subsection{Frequenzmodulation}
Der berechnete Modulationsgrad ist sehr gering, weist dafür aber nur einen geringen Fehler auf. Die beiden berechneten Werte stimmen nicht überein, sind jedoch sehr nah beieinander. Das Trägersignal ist gut auf dem Frequenzspektrum zu sehen.
