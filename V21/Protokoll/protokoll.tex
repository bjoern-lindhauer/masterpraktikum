...
\begin{center}
	...
	\captionof{figure}{Aufbau der Messapparatur, Seitenansicht [1]}
...
\subsection{Bestimmung der Zeitkonstante des exponentiellen Anstiegs}
In Abbildung \ref{fig:anstieg} ist der exponentielle Anstieg des Signalverlaufes nach Anschalten der RF-Spannung dargestellt. \\
Zur Bestimmung der Zeitkonstante wird ein exponentieller Ansatz der Form
\begin{align*}
U(t)=a+\left(1-\exp\left(t/\tau\right) \right)+b
\end{align*}
für eine nicht-lineare Ausgleichsrechnung verwendet. Die Ausgleichsrechnung wird mithilfe von Python durchgeführt. \\
Es ergeben sich folgende Parameter:
\begin{align*}
a=(12.50 \pm 0.02)\si{\volt} && b=(4.89 \pm 0.02) \si{\volt} && \tau=(7.40 \pm 0.02) \si{\milli\second}\,.
\end{align*}
\begin{center}
	\includegraphics[width=10cm]{images/anstieg.pdf}
	\captionof{figure}{Exponentieller Anstieg des Signalverlaufs und nicht-linearer Fit}
	\label{fig:anstieg}
\end{center}

\subsection{Bestimmung des Verhältnisses b($^{85}$Rb)/b($^{87}$Rb)}
...
\begin{align*}
a_1&=(0.012 \pm 0.016)\si{\milli\second} & a_2&=(0.050 \pm 0.025)\si{\milli\second} \\
b_1&=(2.222 \pm 0.091)\si{\volt\milli\second} & b_2&=(3.108 \pm 0.140)\si{\volt\milli\second} \\
c_1&=(0.034 \pm 0.091)\si{\volt} &
c_1&=(-0.008 \pm 0.040)\si{\volt}\,.
\end{align*}
Somit ergibt sich für das gesuchte Verhältnis
\begin{align*}
\frac{b(^{85}Rb)}{b(^{87}Rb)}\approx 1.40 \pm 0.09\,.
\end{align*}
\section{Diskussion}
...
Das Verhältnis der b-Werte liegt mit 1.40 nah am Theoriewert von 1.5. Die Abweichung liegt jedoch nicht im Rahmen des angegebenen Fehlers.
